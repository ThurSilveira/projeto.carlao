...
class CancelarEscalaUseCase @Inject constructor(private val repository: EscalaRepository) {
    suspend operator fun invoke(id: Long): ApiResult<Escala> = repository.cancelar(id)
}
