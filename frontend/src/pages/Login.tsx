      ...
      <div className="w-full max-w-5xl overflow-hidden rounded-2xl bg-white dark:bg-neutral-850 border border-slate-200 dark:border-neutral-700 shadow-xl grid lg:grid-cols-[1.05fr_1fr]">
        <section className="hidden lg:flex flex-col justify-between bg-primary-700 text-white p-12 min-h-[620px] relative overflow-hidden">
          ...
          <div className="relative">
            ...
            <h1 className="text-4xl leading-tight font-bold max-w-md">Gestão responsável das escalas ministeriais.</h1>
          ...
          <form onSubmit={submit} className="mt-6 space-y-5">
            <div>
              ...
              <input
                ...
                required
                maxLength={254}
                className="w-full rounded-lg border border-slate-300 dark:border-neutral-600 bg-white dark:bg-neutral-800 px-4 py-3 text-slate-900 dark:text-white"
              />
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  maxLength={128}
                  className="w-full rounded-lg border border-slate-300 dark:border-neutral-600 bg-white dark:bg-neutral-800 pl-11 pr-12 py-3 text-slate-900 dark:text-white"
                />
                <button
                  type="button"
                  onClick={() => setShowPassword((visible) => !visible)}
                  className="absolute right-3 top-1/2 -translate-y-1/2 p-1 text-slate-500 dark:text-slate-300 rounded"
